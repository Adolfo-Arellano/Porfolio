  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#8BC34A] via-[#689F38] to-[#1B5E20] pt-10 pb-16">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
        <a className="technologies group col-span-1 sm:col-span-2 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          ...
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">La base de toda buena receta</span>
        ...
        <a className="technologies group col-span-1 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          ...
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">El arte de la presentación</span>
        ...
        <a className="technologies group col-span-1 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          <div className="absolute inset-0 bg-gradient-to-br from-yellow-600 via-amber-400 to-yellow-200 translate-y-[100%] group-hover:translate-y-[0%] transition-transform duration-500 ease-out" />
          <span className="absolute bottom-0 left-2 font-bold text-white text-3xl z-10 pl-1 pb-1">JS</span>
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">La chispa que da vida</span>
        ...
        <a className="technologies group col-span-1 sm:col-span-2 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          ...
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">El fuego que todo lo transforma</span>
        ...
        <a className="technologies group col-span-1 sm:col-span-2 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          ...
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">La receta perfecta, paso a paso</span>
        ...
        <a className="technologies group col-span-1 bg-gray-700/60 overflow-hidden shadow-md hover:shadow-2xl">
          ...
          <span className="absolute top-3 left-3 rounded-lg px-2 py-0.5 bg-white/80 text-gray-900 text-sm font-bold z-10">Los condimentos que dan sabor</span>
